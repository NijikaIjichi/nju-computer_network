...
def test_hub():
    ...
    s.expect(PacketInputEvent("eth0", mypkt, display=Ethernet), "arrive on eth0")
    s.expect(PacketOutputEvent("eth1", mypkt, "eth2", mypkt, display=Ethernet), "flood out eth1 & eth2")
